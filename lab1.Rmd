---
title: "Lab 1: An Introduction to STATA"
...
This lab will cover:
  ...
  - some important tools in the toolbar. 
  - loading data. 
  - using the Graphical User Interface. 

### The Graphical User Interface
Let's get started. <strong> Open up STATA </strong>.
...
To see the all the windows in action, start by typing in`sysuse auto` in the <strong> [command-line interface](cheatsheets.html) </strong>. The windows will spring into life.  
...
<strong>Click on the
![](/Users/home_folder/econ5060_website/images/lab 1/Picture4.jpg) symbol </strong>. You should see a screen like this: 
...
Some things that I want to point out that are useful. Notice at the bottom left-hand corner it shows this ![](/Users/home_folder/econ5060_website/images/lab 1/Picture7.jpg). his tells us a few useful things such as the number of variables and the number of observations. Take some time to explore, when you are done, <strong> exit the screen </strong>.

Next, <strong>click on the ![](/Users/home_folder/econ5060_website/images/lab 1/Picture8.jpg) symbol.</strong> You will return to a familiar screen: 
...
Congratulations, you have completed the first lab. Hopefully this gave you a brief idea of the program and some of its features.  
