...
-> type in `sysuse auto` into the command line interface (CLI). 
...
-> type `sysuse cancer` in the CLI. <br>
-> type `sysuse voter` in the CLI. <br>
-> type `sysuse census` in the CLI.
