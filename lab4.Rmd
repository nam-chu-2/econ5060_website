...
<div class="card">
  <div class="card-body">
-> Open up a new do file. Type the following script, adjusting any parts as appropriate (eg. your name, student number, and paths).
  </div>
</div>
![](/Users/home_folder/econ5060_website/images/lab_4/Picture1.png)
Now we'll practice looking up information from STATA's official documentation. 

-> Go to google and look up "STATA language syntax". Click on the official STATA documentation for language syntax. It should look like the screenshot below.

![](/Users/home_folder/econ5060_website/images/lab_4/Picture2.png)

-> Scroll down until the end of page one where you will see STATA’s syntax:

![](/Users/home_folder/econ5060_website/images/lab_4/Picture3.png)
...
-> Type in "regress stata documentation" on Google. Click on the official STATA documentation for Linear regression. Scroll down until you see the syntax page. 

![](/Users/home_folder/econ5060_website/images/lab_4/Picture4.png)
![](/Users/home_folder/econ5060_website/images/lab_4/Picture5.png)
Now we'll expand on the `regress` command that we've used previously. 

-> Type in the following below `regress price mpg` in your do file.
...
<strong>Tip: In STATA, you don’t have to type in the full name of a command. The underlined portion tells you the shortest allowable written version of the command. If you are a beginner, I would suggest that you type out all the longform versions of the command for practice and for readability. 

![](/Users/home_folder/econ5060_website/images/lab_4/Picture6.png) </strong> 

Your entire do file up to this point should look like this:

![](/Users/home_folder/econ5060_website/images/lab_4/Picture7.png)

Congratulations, you’ve finished the fourth lab!
