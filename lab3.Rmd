...
-> In the CW, type `cd "your_path_name"` (where your_path_name is your path's name, for example `cd "/Users/home_folder/econ5060_website/labs/lab_3"`.

 Now you’ve changed your officially changed your working directory. Anything that you save or import using the Command window will be from your working directory.  
...
Congratulations, you’ve finished the third lab!
